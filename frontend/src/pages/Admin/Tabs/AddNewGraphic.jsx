...
const AddNewGraphic = () => {
  ...
  <div className="flex flex-col gap-4 border-b py-4 sm:flex-row">
    ...
    <input name='url' placeholder="https://zyx.com/myimage.jpeg" className="w-full rounded-md border bg-white px-2 py-2 outline-none ring-blue-600 focus:ring-1"  onChange={HandleData} />
  </div>
  <div className="flex flex-col gap-4 border-b py-4 sm:flex-row">
