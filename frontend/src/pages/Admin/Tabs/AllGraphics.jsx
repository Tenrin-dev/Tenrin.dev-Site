...
import { useDeleteGraphicMutation, useGetGraphicsQuery } from '../../../redux/Api/GraphicApi'
...
const AllGraphic = () => {
  ...
  const [deleteCat] = useDeleteGraphicMutation()
  ...
  <div className="sm:flex sm:items-center sm:justify-between">
    <div>
      <div className="flex items-center gap-x-3">
        <h2 className="text-xl text-gray-800 font-bold">All Graphics</h2>
    ...
    <div className="flex items-center mt-4 gap-x-3">
      ...
      <button onClick={()=>Navigate("/myadmin-panel/graphic")} className="flex items-center justify-center w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 rounded-lg shrink-0 sm:w-auto gap-x-2  hover:bg-blue-500 bg-blue-600">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-5 h-5">
          <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v6m3-3H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z" />
        </svg>
        <span>Add New Graphics/Image</span>
      </button>
    </div>
  </div>
          ...
          <table className="min-w-full h-auto divide-y divide-gray-700">
            <thead className="bg-gray-800 sticky top-0">
              <tr>
                ...
                <th scope="col" className="px-4 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-400">Width</th>
                <th scope="col" className="px-4 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-400">Height</th>
            ...
            <tr key={item?._id}>
                ...
                <div className="px-3 py-1 text-sm font-normal rounded-full text-[#a3a3a3]">
                  ...
                  <h2 className="title-font font-medium text-gray-200 mb-3 truncate whitespace-break-spaces">{index+1}</h2>                   
                </div>
                ...
                <div className="px-3 py-1 text-sm font-normal rounded-full text-[#a3a3a3]">
                  ...
                  <h2 className="title-font font-medium text-gray-200 mb-3 truncate whitespace-break-spaces">{item?.url}</h2>                   
                </div>
                ...
                <div className="px-3 py-1 text-sm font-normal rounded-full text-[#a3a3a3]">
                  ...
                  <h2 className="title-font font-medium text-gray-200 mb-3 truncate whitespace-break-spaces">{item?.caption}</h2>                   
                </div>
                ...
                <div className="px-3 py-1 text-sm font-normal rounded-full text-[#a3a3a3]">
                  ...
                  <h2 className="title-font font-medium text-gray-200 mb-3 truncate whitespace-break-spaces">{item?.width}</h2>                   
                </div>
                ...
                <div className="px-3 py-1 text-sm font-normal rounded-full text-[#a3a3a3]">
                  ...
                  <h2 className="title-font font-medium text-gray-200 mb-3 truncate whitespace-break-spaces">{item?.height}</h2>                   
                </div>
