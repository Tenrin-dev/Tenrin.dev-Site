...
import { useDeleteVideoMutation, useGetVideosQuery } from '../../../redux/Api/VideoApi'
...
const AllVideos = () => {
  ...
  const [deleteCat] = useDeleteVideoMutation()
  ...
  <div className="sm:flex sm:items-center sm:justify-between">
    <div>
      <div className="flex items-center gap-x-3">
        <h2 className="text-xl text-gray-800 font-bold">All Videos</h2>
    ...
    <div className="flex items-center mt-4 gap-x-3">
      ...
      <button onClick={()=>Navigate("/myadmin-panel/video")} className="flex items-center justify-center w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 rounded-lg shrink-0 sm:w-auto gap-x-2  hover:bg-blue-500 bg-blue-600">
          ...
          <table className="min-w-full h-auto divide-y divide-gray-700">
            <thead className="bg-gray-800 sticky top-0">
              <tr>
                ...
                <th scope="col" className="px-4 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-400">Description</th>
            ...
            <tr key={item?._id}>
                ...
                <div className="px-3 py-1 text-sm font-normal rounded-full text-[#a3a3a3]">
                  ...
                  <h2 className="title-font font-medium text-gray-200 mb-3 truncate whitespace-break-spaces">{item?.poster}</h2>                   
                </div>
                ...
                <div className="px-3 py-1 text-sm font-normal rounded-full text-[#a3a3a3]">
                  ...
                  <h2 className="title-font font-medium text-gray-200 mb-3 truncate whitespace-break-spaces">{item?.description}</h2>                   
                </div>
